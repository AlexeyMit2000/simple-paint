...
namespace paint_alexey
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("привет это простой графический редактор" +
                " здесь мы можете рисовать и выбирать цвет и толщину" +
                " также открыть и сохранить свои работы" +
                " в формате jpeg");
        }
